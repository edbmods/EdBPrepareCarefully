...
namespace EdB.PrepareCarefully {
    public class PanelName : PanelBase {
        ...
        public override void Resize(Rect rect) {
            ...
            float availableSpace = PanelRect.width - (panelPadding * 2) - RectRandomize.width - fieldPadding;
            ...
            RectFirstName = new Rect(panelPadding, top, firstMinWidth + extraForField, fieldHeight);
