...
namespace EdB.PrepareCarefully {
    public class DialogConfirm : Window {
        ...
        public DialogConfirm(string text, Action confirmedAction) {
            this.text = text;
        ...
        public DialogConfirm(string text, Action confirmedAction, bool destructive) {
            this.text = text;
            this.confirmedAction = confirmedAction;
        ...
        public DialogConfirm(string text, Action confirmedAction, bool destructive, string title) {
            this.text = text;
            this.confirmedAction = confirmedAction;
            this.destructiveAction = destructive;
            this.title = title;
        ...
        public DialogConfirm(string text, Action confirmedAction, bool destructive, string title, bool showGoBack) {
            this.text = text;
            this.confirmedAction = confirmedAction;
            this.destructiveAction = destructive;
            this.title = title;
