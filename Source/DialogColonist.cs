...
namespace EdB.PrepareCarefully {
    public abstract class DialogColonist : Window {
                ...
                foreach (FileInfo current in list) {
                    ...
                    try {
                        ...
                        if (Widgets.ButtonImage(rect4, Textures.TextureDeleteX)) {
                            ...
                            Find.UIRoot.windows.Add(new DialogConfirm("EdB.PC.Dialog.PawnPreset.ConfirmDelete".Translate(localFile.Name), delegate {
                                localFile.Delete();
                            }, true, null, true));
                        }
