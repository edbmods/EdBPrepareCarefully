...
namespace EdB.PrepareCarefully {
    public abstract class DialogPreset : Window {
        ...
        public override void DoWindowContents(Rect inRect) {
            ...
            foreach (FileInfo current in list) {
                ...
                if (Widgets.ButtonImage(rect4, Textures.TextureDeleteX)) {
                    ...
                    Find.UIRoot.windows.Add(new DialogConfirm("EdB.PC.Dialog.Preset.ConfirmDelete".Translate(localFile.Name), delegate {
                        localFile.Delete();
                    }, true, null, true));
                }
