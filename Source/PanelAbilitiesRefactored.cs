...
namespace EdB.PrepareCarefully {
    public class PanelAbilitiesRefactored : PanelModule {
        ...
        protected WidgetField FieldFaction = new WidgetField();
        ...
        public bool AnyDefinedAbilities = false;

        public void PostConstruct() {
            AnyDefinedAbilities = DefDatabase<AbilityDef>.DefCount > 0;
        }
        ...
        public override float Draw(float y) {
            ...
            GUI.DrawTexture(addRect, Textures.TextureButtonManage);
